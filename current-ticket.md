...
[] when a session is in progress, the ribeyes requests dialogs are not the right height, the half-rebuy works but the full-rebuy does not have the same height, they should be equal (this might have been fixed already)
