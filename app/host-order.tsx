...
import { Sortable, DropProvider, SortableItem } from 'react-native-reanimated-dnd';
...
export default function HostOrderScreen() {
  ...
  const renderItem = ({ item, id, positions, lowerBound, autoScrollDirection, itemsCount }: SortableRenderItemProps<HostItem>) => {
    ...
    return (
      ...
      >
        <View className="mx-6 mb-2 flex-row items-center rounded-lg border border-sand-200 bg-sand-100 px-4 dark:border-sand-700 dark:bg-sand-800" style={{ height: ITEM_HEIGHT - 8 }}>
          ...
          <View className="mr-3 h-8 w-8 items-center justify-center rounded-full bg-sand-200 dark:bg-sand-600">
